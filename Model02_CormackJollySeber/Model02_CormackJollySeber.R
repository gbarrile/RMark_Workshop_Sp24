...
# Model 2 - Cormack-Jolly-Seber (CJS) Model to estimate survival
...
# a note on the 'age' variable in the design data
d.ddl$Phi
# age = current year - birth cohort
# so age starts at 0 from the first time individuals appear in the capture history, not their literal age
# you could add a column of true ages if that is known (e.g., individual covariate on age) or maybe group by adults vs juveniles
...
# compare to beta estimate from model?
top.aic$results$beta
