...
# Model 4 - Reverse-time Pradel models to estimate survival, recruitment, and population growth
...
# Results from Model 3 (Robust with Temporary Emigration) suggested that capture probability at our northern
